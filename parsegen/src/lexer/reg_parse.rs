...
Some(_)  if self.check_buf(&[]) != 2 => {let r = self.check_buf(&[]);
if r == 1 { had_pref = true; }
else if r == 0 {
self.stack.pop();
...
Some(0) if self.check_buf(&[]) != 2 => {let r = self.check_buf(&[]);
if r == 1 { had_pref = true; }
else if r == 0 {
self.stack.pop();
self.cur = 465;
...
Some(6) if self.check_buf(&[]) != 2 => {let r = self.check_buf(&[]);
if r == 1 { had_pref = true; }
else if r == 0 {
self.stack.pop();
self.cur = 499;
...
Some(3) if self.check_buf(&[]) != 2 => {let r = self.check_buf(&[]);
if r == 1 { had_pref = true; }
else if r == 0 {
self.stack.pop();
self.cur = 820;
...
Some(28) if self.check_buf(&[]) != 2 => {let r = self.check_buf(&[]);
if r == 1 { had_pref = true; }
else if r == 0 {
self.stack.pop();
self.cur = 576;
...
Some(5) if self.check_buf(&[]) != 2 => {let r = self.check_buf(&[]);
if r == 1 { had_pref = true; }
else if r == 0 {
self.stack.pop();
self.cur = 823;
...
Some(10) if self.check_buf(&[]) != 2 => {let r = self.check_buf(&[]);
if r == 1 { had_pref = true; }
else if r == 0 {
self.stack.pop();
self.cur = 824;
...
Some(13) if self.check_buf(&[]) != 2 => {let r = self.check_buf(&[]);
if r == 1 { had_pref = true; }
else if r == 0 {
self.stack.pop();
self.cur = 858;
...
Some(18) if self.check_buf(&[]) != 2 => {let r = self.check_buf(&[]);
if r == 1 { had_pref = true; }
else if r == 0 {
self.stack.pop();
self.cur = 858;
...
Some(9) if self.check_buf(&[]) != 2 => {let r = self.check_buf(&[]);
if r == 1 { had_pref = true; }
else if r == 0 {
self.stack.pop();
self.cur = 858;
